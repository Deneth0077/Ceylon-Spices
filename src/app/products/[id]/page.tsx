            ...
            <div className="flex flex-col sm:flex-row gap-4 border-t border-[#eae7e7] pt-6">
              ...
              <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="w-full py-3.5 border-2 border-[#42190a] hover:bg-[#42190a]/5 text-[#42190a] font-bold text-xs uppercase tracking-wider rounded-lg transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
                  Order via WhatsApp
                </button>
              </div>
