    ...
    <div className="relative w-full bg-[#fcf9f8] text-[#1b1c1c] overflow-x-hidden">
      ...
      <section className="max-w-[1280px] mx-auto px-6 md:px-8 py-16 border-t border-[#eae7e7]/60">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="group relative rounded-2xl overflow-hidden shadow-premium bg-[#111613] text-white h-[360px] md:h-[420px] md:col-span-4 flex flex-col justify-end p-8 transition-transform duration-300 hover:translate-y-[-4px]">
            <div className="absolute inset-0 z-0">
              <Image
                src="/images/cinnamon_leaf_oil_jar_real.png"
            ...
            <div className="relative z-10 space-y-3">
              <h3 className="font-serif text-xl md:text-2xl font-bold text-white drop-shadow-md">Cinnamon Leaf Oil</h3>
              <Link
                href="/products"
